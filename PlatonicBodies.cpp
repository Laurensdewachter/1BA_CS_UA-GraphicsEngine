...
Figure PlatonicBodies::getCubeFigure() const {
    return cubeFigure;
}

Figure PlatonicBodies::getTetrahedronFigure() const {
    return tetrahedronFigure;
}

Figure PlatonicBodies::getOctahedronFigure() const {
    return octahedronFigure;
}

Figure PlatonicBodies::getIcosahedronFigure() const {
    return icosahedronFigure;
}

Figure PlatonicBodies::getDodecahedronFigure() const {
